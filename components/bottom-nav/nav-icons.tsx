    ...
    >
      ...
      {isActive && (
        <div style={{
          ...
          background: "conic-gradient(from 0deg, rgba(139,92,246,0), rgba(167,139,250,0.55), rgba(251,191,36,0.4), rgba(139,92,246,0.5), rgba(167,139,250,0), rgba(139,92,246,0))",
          animation: "auroraRing 3s linear infinite",
          maskImage: "radial-gradient(circle, transparent 55%, black 70%, black 100%)",
          WebkitMaskImage: "radial-gradient(circle, transparent 55%, black 70%, black 100%)",
        }} />
      )}
      ...
      {isActive && (
        <div style={{
          ...
          background: "radial-gradient(circle, rgba(139,92,246,0.30) 0%, rgba(139,92,246,0.08) 60%, transparent 80%)",
      ...
      {isActive && PARTICLES.map((p, i) => (
        <div
          ...
          style={{
            ...
            background: i % 2 === 0 ? "rgba(167,139,250,0.9)" : "rgba(251,191,36,0.85)",
            boxShadow: i % 2 === 0 ? "0 0 3px rgba(167,139,250,0.8)" : "0 0 3px rgba(251,191,36,0.8)",
      ...
      {/* ✨ icon */}
      <span style={{
        fontSize: 17, position: "relative", zIndex: 2, lineHeight: 1,
