...
describe("RecipeForm", () => {
    ...
    describe("Create Mode", () => {
        it("renders empty form for creating new recipe", () => {
            ...
            expect(screen.getByRole("button", { name: /createRecipe/i })).toBeInTheDocument();
        });
        ...
        it("shows validation errors for required fields", async () => {
            ...
            const submitButton = screen.getByRole("button", { name: /createRecipe/i });
        ...
        it("can add and remove ingredients", async () => {
            ...
            const ingredientInputs = screen.getAllByPlaceholderText(/ingredientName/i);
            ...
            await waitFor(() => {
                expect(screen.getAllByPlaceholderText(/ingredientName/i)).toHaveLength(2);
            });
            ...
            await waitFor(() => {
                expect(screen.getAllByPlaceholderText(/ingredientName/i)).toHaveLength(1);
            });
        });
        ...
        it("can add and remove instruction steps", async () => {
            ...
            const instructionInputs = screen.getAllByPlaceholderText(/instructionStep/i);
            ...
            await waitFor(() => {
                expect(screen.getAllByPlaceholderText(/instructionStep/i)).toHaveLength(2);
            });
        });
    });
    ...
    describe("Edit Mode", () => {
        ...
        it("renders form pre-filled with recipe data", () => {
            ...
            const servingsInput = screen.getByLabelText(/servings/i);
            expect(servingsInput).toHaveValue(4);
            expect(screen.getByRole("button", { name: /updateRecipe/i })).toBeInTheDocument();
        });
